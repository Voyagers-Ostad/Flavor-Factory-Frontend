      ...
      <div className="  justify-content-center m-5 p-5  bg-light border border-secondary">
        ...
        <Form onSubmit={handleSubmit} className="d-flex flex-column ">
          <Form.Group controlId="formTitle">
            <h5>
              Title<p className="text-danger mt-2 d-inline">*</p>
            </h5>
            <Form.Control
              type="text"
          ...
          <Form.Group className="mt-4 " controlId="formIsBake">
            <h5 className="r">
              Bake<p className="text-danger mt-2 d-inline">*</p>
            </h5>
            <Col>
              <Form.Check
                type="radio"
          ...
          <Form.Group controlId="formIngredients" className="mt-4">
            <h5>
              Ingredients<p className="text-danger mt-2 d-inline">*</p>
              (comma-separated)
            </h5>
            <Form.Control
              type="text"
          ...
          <div className="d-flex ">
            <div>
              <Form.Group controlId="formPhoto">
                <h5 className="mt-4">
                  Photo<p className="text-danger mt-2 d-inline">*</p>
                </h5>
                <Form.Control
                  type="file"
                  name="photo"
                ...
                />
                {errors.photo && (
                  <p className="text-danger mt-2">{errors.photo}</p>
                )}
              </Form.Group>
            </div>
            ...
            <div>
              <h5 className="mt-4 ">
                Meal Type<p className="text-danger mt-2 d-inline">*</p>
              </h5>
              <Form.Select
                name="meal"
                value={recipe.meal}
            ...
            <div>
              <h5 className="mt-4 ml-2">
                Category<p className="text-danger mt-2 d-inline">*</p>
              </h5>
              <Form.Select
                name="category"
            ...
            <div>
              <h5 className="mt-4 ml-2">
                Cuisine<p className="text-danger mt-2 d-inline">*</p>
              </h5>
              <Form.Select
                name="cuisine"
          ...
          <Form.Group controlId="formOccasion">
            <h5 className="mt-4">
              Occasion<p className="text-danger mt-2 d-inline">*</p>
            </h5>
            <Form.Control
              type="text"
              placeholder=""
          ...
          <Form.Group controlId="formCooktime">
            <h5 className="mt-4">
              Cooktime<p className="text-danger mt-2 d-inline">*</p>
            </h5>
            <Form.Control
              type="text"
              placeholder=""
          ...
          <Form.Group controlId="formDetail">
            <h5 className="mt-4">
              Detail<p className="text-danger mt-2 d-inline">*</p>
            </h5>
            <Form.Control
              type="text"
              placeholder=""
